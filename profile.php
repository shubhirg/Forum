...
<?php
	...
	echo "
	<center>
	<div class='table-responsive' style='width: 60%' cellspacing='0' cellpadding='0' class='table-bordered' >
    <table class='table-borederd'>
	";
	while($row_type)
	{
		echo '<tr>';
		...
		echo '<tr>';
		echo "<td>"; 
		echo "<a href = 'editprofile.php'>Edit Profile";				/*link*/
		echo "</td>";
		echo '</tr>';
