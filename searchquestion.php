...
<?php
	...
	$sql_question = "SELECT * FROM question WHERE content LIKE '%" .$question. "%'";
	...
	while($row_question = mysqli_fetch_array($res_question))
	{
		...
		echo '<tr>';
		echo "<td>No Questions have been asked related to this.";
		echo "</td>";
		echo '</tr>';
		echo '<tr>';
		echo "<td><a href = 'ask.php'>Be the first to ask!";
		echo "</td>";
		echo '</tr>';
	}
	echo " 
